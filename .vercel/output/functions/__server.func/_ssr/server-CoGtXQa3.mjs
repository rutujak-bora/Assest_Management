...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-x0ujODY-.mjs");
...
const manifest = {
  "00a12212da0f7fe73e769e4682b11ee26e7d88caeb998b11b7fae32a73987fa2": {
    ...
    importer: () => import("./mongo.functions-CusmzGOr.mjs")
  },
  ...
  "e290cc98557908cfb5f64f92732a26790fdb57d959705b95ba53c60da4d876b5": {
    ...
    importer: () => import("./seed.functions-BMF0qp5a.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BNuwQEIf.mjs").then((n) => n.r),
    import("./start-9EsdD6SX.mjs"),
