...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D-Hz8vSv.mjs");
...
const manifest = {
  "00a12212da0f7fe73e769e4682b11ee26e7d88caeb998b11b7fae32a73987fa2": {
    ...
    importer: () => import("./mongo.functions-ClQGvoVI.mjs")
  },
  ...
  "e290cc98557908cfb5f64f92732a26790fdb57d959705b95ba53c60da4d876b5": {
    ...
    importer: () => import("./seed.functions-BQkG-57I.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CXOTuEAP.mjs").then((n) => n.r),
    import("./start-DAvj_IXC.mjs"),
