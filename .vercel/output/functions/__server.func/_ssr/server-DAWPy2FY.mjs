...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BAMmMjAP.mjs");
...
const manifest = {
  "00a12212da0f7fe73e769e4682b11ee26e7d88caeb998b11b7fae32a73987fa2": {
    functionName: "deleteEmployee_createServerFn_handler",
    importer: () => import("./mongo.functions-Crd8ccpR.mjs")
  },
  "18d703905bd6bf757ffcded1ed14cb9ecb1cf2e6d2015de483f2a2b5036414e3": {
    functionName: "getEmployees_createServerFn_handler",
    importer: () => import("./mongo.functions-Crd8ccpR.mjs")
  },
  "255b4b5f73c94496362d80146eb9b258a15d55fe01cf58df4166aa4764d86815": {
    functionName: "upsertAsset_createServerFn_handler",
    importer: () => import("./mongo.functions-Crd8ccpR.mjs")
  },
  "2ff94551da8f429a4da496f6f044619ede67cacecfa3cd3eeb3e0e1d5870b64c": {
    functionName: "getMasterData_createServerFn_handler",
    importer: () => import("./mongo.functions-Crd8ccpR.mjs")
  },
  "4fdc7c129791dd35bcd280e49ec4f98898a28393d7668544a5551800d2a2ea98": {
    functionName: "getAuditLogs_createServerFn_handler",
    importer: () => import("./mongo.functions-Crd8ccpR.mjs")
  },
  "62cce31f1508dc566c9509bc7496749ce2ace292d5e7190cc9db8b87e3834556": {
    functionName: "getAssets_createServerFn_handler",
    importer: () => import("./mongo.functions-Crd8ccpR.mjs")
  },
  "84d8194c5c9234215420a6b7eaad4d744f53aca4c7a06ca661173b38dd2dd63f": {
    functionName: "upsertMasterItem_createServerFn_handler",
    importer: () => import("./mongo.functions-Crd8ccpR.mjs")
  },
  "960ddee371bf5c8f1d5819ca80da11d0238bd4b7e2fa325a040e3ecce5b6820c": {
    functionName: "returnAssignment_createServerFn_handler",
    importer: () => import("./mongo.functions-Crd8ccpR.mjs")
  },
  "9b1e1a31437f3cdf215d5f116b96fb7a43ee75d0e8e477d28e51aa5dcb73293b": {
    functionName: "getAssignments_createServerFn_handler",
    importer: () => import("./mongo.functions-Crd8ccpR.mjs")
  },
  "a7dbde77d5edada0b0af8e747a29e9bcb4c77c35e89f04fab028be8757c56424": {
    functionName: "deleteAsset_createServerFn_handler",
    importer: () => import("./mongo.functions-Crd8ccpR.mjs")
  },
  "a86672390c062b0bbd3129cf1a292ad64d4857baa9667c1ce1c793f9a4b8b8ef": {
    functionName: "upsertEmployee_createServerFn_handler",
    importer: () => import("./mongo.functions-Crd8ccpR.mjs")
  },
  "b5fc8b127fedb99f8ffffa7e47d3bb5fbbcd9670fa302aa33a069dc77c1d5001": {
    functionName: "loginMongoUser_createServerFn_handler",
    importer: () => import("./mongo.functions-Crd8ccpR.mjs")
  },
  "b66c3b1b7961567802fe97c3ce1c02a6bfe34778e1879934f9f43e1d11cbe5df": {
    functionName: "deleteMasterItem_createServerFn_handler",
    importer: () => import("./mongo.functions-Crd8ccpR.mjs")
  },
  "c3f06f4d22992207d4a20cf35775d094dfc2c9df6c86d2724728a626e3e7ac03": {
    functionName: "createAuditLog_createServerFn_handler",
    importer: () => import("./mongo.functions-Crd8ccpR.mjs")
  },
  "cb8010ec2eaa8305ba1e44a611e2405c26860a20335dfa820c3b21e66781a642": {
    functionName: "getAssetById_createServerFn_handler",
    importer: () => import("./mongo.functions-Crd8ccpR.mjs")
  },
  "e290cc98557908cfb5f64f92732a26790fdb57d959705b95ba53c60da4d876b5": {
    functionName: "seedDefaultUsers_createServerFn_handler",
    importer: () => import("./seed.functions-D0G1HMxj.mjs")
  },
  "f8090c82a2eb11df9c08d51bffc614553c8bfe280a4395fe108c405ae0e503d6": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D3LxaChY.mjs").then((n) => n.r),
    import("./start-D70xjARY.mjs"),
