...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BgT89CVn.mjs");
...
const manifest = {
  "00a12212da0f7fe73e769e4682b11ee26e7d88caeb998b11b7fae32a73987fa2": {
    ...
    importer: () => import("./mongo.functions-DwPjFS9t.mjs")
  },
  ...
  "e290cc98557908cfb5f64f92732a26790fdb57d959705b95ba53c60da4d876b5": {
    ...
    importer: () => import("./seed.functions-f7qoGATK.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Df4bQx53.mjs").then((n) => n.r),
    import("./start-C9yqBMif.mjs"),
